...
menor = min(notas)                     # encontra a menor nota
indice_menor = notas.index(menor)      # pega o índice da menor nota
nova_nota = float(input("Digite a nova nota para substituir a menor: "))
notas[indice_menor] = nova_nota        # substitui no índice correto
